...
3. Choose which folder to use. "WithAutoClicker" is meant to be used while you're AFK, while "WithoutAutoClicker" is meant to be used when you are using the PC at the same time.
